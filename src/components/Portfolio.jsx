...
export default function Portfolio() {
  return (
    <>
        ...
        <p className='my-4'>Hi there! I'm Nishat. A TKH fellow and this is my porfolio made with React. It is a SPA. :)</p>
        <div className='portfolio-container mx-8'>
            <div className='portfolio-item'>
                ...
                <div className='text-right mt-12'>
                   <a href="https://github.com/Nemo080/Portfolio-aboutme"><button className="project-button btn text-black text-sm btn-outline">Github Repo</button></a>
                </div>
            </div>
            <div className='portfolio-item'>
                ...
                <div className='text-right mt-12'>
                    <a href="https://github.com/Nemo080/TKH-adventure"><button className="project-button btn text-black text-sm btn-outline">Github Repo</button></a>
                </div>
            </div>
            <div className='portfolio-item'>
                ...
                <div className='text-right mt-12'>
                    <a href="https://github.com/Nemo080/TKH-RPSGame"><button className="project-button btn text-black text-sm btn-outline">Github Repo</button></a>
                </div>
            </div>
            <div className='portfolio-item'>
                ...
                <div className='text-right mt-12'>
                <a href="https://github.com/Nemo080/TKH-KJS"><button className="project-button btn text-black text-sm btn-outline">Github Repo</button></a>
                </div>
            </div>
            <div className='portfolio-item'>
                ...
                <div className='text-right mt-12'>
                <a href="https://github.com/Nemo080/TKH-GroceryList"><button className="project-button btn text-black text-sm btn-outline">Github Repo</button></a>
                </div>
            </div>
            <div className='portfolio-item'>
                ...
                <div className='text-right mt-12'>
                <a href="https://github.com/Nemo080/anime-api"><button className="project-button btn text-black text-sm btn-outline">Github Repo</button></a>
                </div>
            </div>
        </div>
    </>
